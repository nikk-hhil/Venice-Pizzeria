...
const FeaturedMenu = () => {
  ...
  <h2 className="text-3xl font-extrabold mb-2 bg-gradient-to-r from-red-700 to-red-900 bg-clip-text text-transparent tracking-tight transform hover:scale-105 transition-transform duration-300">Our Specialty Pizzas</h2>
